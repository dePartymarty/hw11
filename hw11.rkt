...
(define construct-scope
  (lambda (list-of-2-lists env)
    (if (null? list-of-2-lists)
        '()
        (cons (list (caar list-of-2-lists) (run-parsed-code (cadar list-of-2-lists) env))
           (construct-scope (cdr list-of-2-lists)
                            (extend-env
                             (list (list (caar list-of-2-lists)
                                         (run-parsed-code (cadar list-of-2-lists) env))) env))))))
